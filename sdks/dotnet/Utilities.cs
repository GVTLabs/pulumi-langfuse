...
namespace Pulumi.Langfuse
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Langfuse.version.txt");
    ...
    internal sealed class LangfuseResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public LangfuseResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
